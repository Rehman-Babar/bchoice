...
import { fetchCatagory1 } from "../store/catagores/catagory1";
...
const Catagory1 = () => {
  ...
  const products = useSelector((state) => state.catagory1.items);
  const status = useSelector((state) => state.catagory1.status);
  useEffect(() => {
    if (status === "idle" && products.length === 0) {
      dispatch(fetchCatagory1({ category: "Gift" }));
    }
      ...
      <div className="container mx-auto md:p-4 max-w-[90rem]">
        <div className="flex flex-col lg:flex-row md:justify-between ">
          <div className="max-w-xl xl:max-w-4xl p-4 md:p-0">
            <h1 className="text-xl md:text-4xl  font-bold  mb-1 mt-6">Select Gifts</h1>
            <p className="text-sm md:text-lg text-gray-600 mb-4 md:mb-6 ">
              Here, you can select gifts for your special someone, with a product quality guarantee.
            </p>
          </div>
        </div>
        <div>
        ...
        {/* <div className="fixed bottom-0 left-0 right-0 bg-white border-t py-3 shadow-lg flex justify-between px-8">
          ...
          <Link to="/clothing" className="px-3 py-1 bg-green-500 text-white rounded-sm">
            Skip
          </Link>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t py-3 shadow-lg flex justify-center items-center gap-4 md:gap-6 px-8">
          ...
          {/* Skip Button */}
          <Link to="/jewellery" className="md:px-6 md:py-3 px-3 py-2 text-black border-2 rounded-sm transition-all duration-300 ">
            Skip
          </Link>

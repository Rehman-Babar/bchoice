    ...
    <>
      <div className="flex flex-col xl:flex-row xl:justify-between pt-10 pb-6 pl-3 items-center md:px-28 space-y-4 xl:space-y-0">
        ...
        <div className="flex flex-col items-start mb-2">
          <h1 className="text-2xl text-black md:text-3xl font-bold mb-2">New Arrival Products</h1>
        ...
        <div className="glass px-4 py-4 bg-white backdrop-blur-md rounded-lg w-full xl:w-auto">
          <Link
            to={"/addproducts"}
            className="text-2xl  text-white flex items-center justify-center w-full xl:w-12 h-12 rounded-full transition-transform duration-300 ease-in-out hover:scale-110 hover:shadow-[0_0_15px_rgba(255,255,255,0.8)]">
